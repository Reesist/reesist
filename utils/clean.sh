...
rm -f src/config/reesist-config.h
...
rm -rf test_bitcoin.coverage/ reesist-gtest.coverage/ total.coverage/
...
clean_exe src/reesist-cli
clean_exe src/reesistd
clean_exe src/reesist-gtest
clean_exe src/reesist-tx
clean_exe src/test/test_reesist
clean_exe src/test/test_reesist_fuzzy
...
clean_dep . src/config/reesist-config.h.in
