...
with the reesistd(s) being tested (using python's asyncore package); the other
implements the test logic.

- `P2PConnection` is the class used to connect to a reesistd.  `P2PInterface`
...
Basic code to support P2P connectivity to a reesistd.
