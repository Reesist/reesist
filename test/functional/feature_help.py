...
"""Verify that starting reesistd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start reesistd with -h for help text")
        ...
        self.log.info("Start reesistd with -version for version information")
