...
official/supported Docker Images found at https://hub.docker.com/r/reesist/reesistd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/reesist/reesistd-develop/ when changing the above text**