...
#error Client version information missing: version is not defined by reesist-config.h or in any other way
#endif
...
/**
 * reesistd-res.rc includes this file, but it cannot cope with real c++ code.
