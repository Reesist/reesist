...
class ReesistorNodeCollaterals;
struct Collateral {
	int height;
	CAmount amount;
};
...
public:
	ReesistornodeCollaterals(vector<Collateral> collaterals = {}, vector<RewardPercentage> rewardPercentages = {});
	...
	virtual ~ReesistornodeCollaterals();
};
