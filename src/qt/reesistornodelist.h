...
/** Reesistornode Manager page widget */
class ReesistornodeList : public QWidget
{
    Q_OBJECT

public:
    explicit ReesistornodeList(QWidget* parent = 0);
    ~ReesistornodeList();
...
private:
    ...
    QTimer* timer;
    Ui::ReesistornodeList* ui;
    ClientModel* clientModel;
    WalletModel* walletModel;

    // Protects tableWidgetReesistornodesDIP3
...
private Q_SLOTS:
    ...
    void on_checkBoxMyReesistornodesOnly_stateChanged(int state);

    void extraInfoDIP3_clicked();
    void copyProTxHash_clicked();
    void copyCollateralOutpoint_clicked();

    void handleReesistornodeListChanged();
