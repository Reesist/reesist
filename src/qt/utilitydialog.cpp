    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  reesist-qt [command-line options]                     \n";
...
All the Reesist in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
The reesistornode mixes up the inputs and instructs all three users' wallets to pay the now-transformed input back to themselves. \
