...
void OptionsDialog::setModel(OptionsModel *_model)
{
    ...
    /* Wallet */
    connect(ui->showReesistornodesTab, SIGNAL(clicked(bool)), this, SLOT(showRestartWarning()));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->showReesistornodesTab, OptionsModel::ShowReesistornodesTab);
