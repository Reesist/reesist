...
/** Utility functions used by the Reesist Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "reesist:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load reesist specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a reesist specific theme is activated (light/dark).*/
