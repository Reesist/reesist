...
/* ReesistGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* ReesistGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Reesist"
#define QAPP_ORG_DOMAIN "reesist.com"
#define QAPP_APP_NAME_DEFAULT "Reesist-Qt"
#define QAPP_APP_NAME_TESTNET "Reesist-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Reesist-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Reesist-Qt-regtest"
