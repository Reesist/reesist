...
* reesist.conf: contains configuration settings for reesistd or reesist-qt
* reesistd.pid: stores the process id of reesistd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by reesistd or reesist-qt
...
* mncache.dat: stores data for reesistornode list
