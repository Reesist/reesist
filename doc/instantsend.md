...
This mechanism has been integrated into Bitcore-Node-Reesist which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/reesist/insight-api-reesist#web-socket-api](https://github.com/reesist/insight-api-reesist#web-socket-api)
* API: [https://github.com/reesist/insight-api-reesist#instantsend-transactions](https://github.com/reesist/insight-api-reesist#instantsend-transactions)
