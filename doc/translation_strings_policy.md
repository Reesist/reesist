...
This document provides guidelines for internationalization of the Reesist Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `reesist_en.ts` remains unchanged.
