...
Fixed governance votes pruning for invalid reesistornodes 
------------------------------------------------------
A community member reported a possible attack that involves DoSing reesistornodes to force the network
to prune all governance votes from this reesistornodes. This could be used to manipulate vote outcomes.

This vulnerability is currently not possible to execute as LLMQ DKGs and PoSe have not activated yet on
mainnet. This version includes a fix that requires to have at least 51% reesistornodes to upgrade to
...
at least 51% of reesistornodes have upgraded to 0.14.0.1.
...
See detailed [set of changes](https://github.com/reesist/reesist/compare/v0.14.0.0...reesist:v0.14.0.1).

- [`a2baa93ec`](https://github.com/reesist/reesist/commit/a2baa93ec) Only require valid collaterals for votes and triggers (#2947) (#2957)
- [`b293e6dde`](https://github.com/reesist/reesist/commit/b293e6dde) Fix off-by-one error in InstantSend mining info removal when disconnecting blocks (#2951)
- [`276b6e3a8`](https://github.com/reesist/reesist/commit/276b6e3a8) bump version to 0.14.0.1 and prepare release notes (#2952)
