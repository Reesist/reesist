Contributing to Reesist Core
============================

The Reesist Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Raptor3um/reesist/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Reesist Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Reesist
Network Protocol consensus changes.

Whether a pull request is merged into Reesist Core rests with the project merge
...
Patches that change Reesist consensus rules are considerably more involved than
...
Where a patch set proposes to change the Reesist consensus, it must have been
...
The review process is normally fairly responsive on the Reesist Core repository, however
...
The project leader is the release manager for each Reesist Core release.
